...
public class CashMultiplyerUpgrade : MonoBehaviour
{
    ...
    public int reqMultiplyer;
    //Change name per upgrade
    public int newMultiplyer;
    ...
    {   
        ...
        else
        {
            ...
            playerManagerScript.setCashMultiplyer(newMultiplyer);
    ...
    private void Update() 
    {
        ...
        if(playerManagerScript.getCashMultiplyer() >= newMultiplyer && !isDeactivated)
        {
            disableButton();
            isBought = true;
        }
        //Change check per script
        if(playerManagerScript.getCashMultiplyer() < reqMultiplyer && !isDeactivated)
        {
            disableButton();
            isBought = false;
        }
        //Change check per script
        else if(playerManagerScript.getCashMultiplyer() == reqMultiplyer && isDeactivated)
        {
            enableButton();
        }
